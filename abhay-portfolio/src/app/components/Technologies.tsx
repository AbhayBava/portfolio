      ...
      <div className="max-w-6xl mx-auto">
        ...
        <AnimatePresence mode="wait">
          <motion.div
            ...
            className="grid sm:grid-cols-3 md:grid-cols-4 gap-6"
          >
            {techGroups[activeTab].stack.map((tech, i) => (
             ...
             shadow-md hover:shadow-lg transition-all cursor-pointer h-36 overflow-hidden"
              >
                {/* Icon + Name block */}
                <div
               ...
               group-hover:-translate-y-2"
                ...
                {/* Description (fade in from bottom on hover) */}
                <div
                  className="absolute bottom-5 text-xs text-center text-gray-500 dark:text-gray-400 
